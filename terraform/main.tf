...
resource "google_cloud_scheduler_job" "scheduler" {
  ...
  http_target {
    http_method = "POST"
    uri = "https://dataflow.googleapis.com/v1b3/projects/${var.project_id}/locations/${var.region}/templates:launch?gcsPath=gs://BUCKET-NAME/templates/dataflow-demo-template"
    oauth_token {
